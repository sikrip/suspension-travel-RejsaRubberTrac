...
#define DEVICE_NAME "FL_WS" // Front Left Wheel
...
#define DROOP_TRAVEL -33 // = 334 - 301
#define SENSOR_RIDE_HEIGHT 346 // the value of the sensor at ride height
#define SENSOR_DROOP 291 // the sensor value at full droop
