...
#define DEVICE_NAME "RL_WS" // Rear Left Wheel
...
#define DROOP_TRAVEL -31 // = 331 - 300
#define SENSOR_RIDE_HEIGHT 52 // the value of the sensor at ride height
#define SENSOR_DROOP 0 // the sensor value at full droop
