...
#define DEVICE_NAME "RR_WS" // Rear Right Wheel
...
#define DROOP_TRAVEL -37 // = 331 - 294
#define SENSOR_RIDE_HEIGHT 435 // the value of the sensor at ride height
#define SENSOR_DROOP 570 // the sensor value at full droop
